...
const completeMasteryTopikIIWordItems = [
  ...
  { id: "mastery2-seagull", pos: "名", text: "갈매기", zh: "海鸥", pairing: "갈매기가 날다", pairingZh: "海鸥飞翔", example: "바닷가에서 갈매기 소리가 들렸다.", exampleZh: "海边传来了海鸥的叫声。", note: "动物名词", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-sense", pos: "名", text: "감각", zh: "感觉 / 感官", pairing: "감각을 키우다", pairingZh: "培养感觉", example: "얼굴을 감싸고 있어 아무런 감각도 없었다.", exampleZh: "脸被包裹着，什么感觉也没有。", note: "感知表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-director", pos: "名", text: "감독", zh: "教练 / 导演", pairing: "감독을 맡다", pairingZh: "担任导演", example: "그는 새 영화의 감독을 맡았다.", exampleZh: "他担任了新电影的导演。", note: "职业名词", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-impression", pos: "名", text: "감명", zh: "感动 / 感触", pairing: "감명을 받다", pairingZh: "受到感动", example: "그 영화를 보고 깊은 감명을 받았다.", exampleZh: "看完那部电影后深受感动。", note: "情感表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-sensibility", pos: "名", text: "감성", zh: "感性", pairing: "감성이 풍부하다", pairingZh: "感情丰富", example: "시인은 풍부한 감성으로 글을 쓴다.", exampleZh: "诗人以丰富的感性写作。", note: "抽象名词", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-emotional", pos: "名", text: "감성적", zh: "感性的", pairing: "감성적인 사람", pairingZh: "感性的人", example: "이성적일 때도 있지만 감성적으로 판단할 때도 있다.", exampleZh: "有时理性判断，有时也会感性判断。", note: "人物描述", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-decrease", pos: "名", text: "감소", zh: "减少", pairing: "매출이 감소하다", pairingZh: "销售额减少", example: "고객 감소로 매출도 줄었다.", exampleZh: "顾客减少，销售额也下降了。", note: "变化表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-decrease-rate", pos: "名", text: "감소율", zh: "减少率", pairing: "감소율이 커지다", pairingZh: "减少率增大", example: "교통사고 감소율이 작년보다 커졌다.", exampleZh: "交通事故的减少率比去年提高了。", note: "统计表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-sensitivity", pos: "名", text: "감수성", zh: "感受力 / 敏感性", pairing: "감수성이 예민하다", pairingZh: "感受力敏锐", example: "사춘기에는 감수성이 더욱 예민해질 수 있다.", exampleZh: "青春期的感受力可能更加敏锐。", note: "心理表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-surveillance", pos: "名", text: "감시", zh: "监视", pairing: "감시 대상", pairingZh: "监视对象", example: "그 사람은 감시 대상이 되었다.", exampleZh: "那个人成了监视对象。", note: "社会行为", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-emotion", pos: "名", text: "감정", zh: "感情 / 情绪", pairing: "감정을 조절하다", pairingZh: "调节情绪", example: "감정이 풍부해야 노래를 잘 표현할 수 있다.", exampleZh: "感情丰富才能更好地表达歌曲。", note: "情感表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-emotionally", pos: "名", text: "감정적", zh: "情绪化的", pairing: "감정적으로 대응하다", pairingZh: "情绪化地应对", example: "문제를 감정적으로 처리하지 마세요.", exampleZh: "请不要情绪化地处理问题。", note: "态度表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-reflection", pos: "名", text: "감회", zh: "感慨 / 感触", pairing: "감회가 깊다", pairingZh: "感慨很深", example: "오랜만에 다시 찾으니 감회가 새로웠다.", exampleZh: "时隔很久再次来到这里，感慨万千。", note: "情感表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-circle-dance", pos: "名", text: "강강술래", zh: "圆圈舞", pairing: "강강술래를 하다", pairingZh: "跳圆圈舞", example: "마을 사람들은 명절에 강강술래를 했다.", exampleZh: "村民们在节日里跳了圆圈舞。", note: "传统文化", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-podium", pos: "名", text: "강단", zh: "讲台", pairing: "강단에 올라서다", pairingZh: "走上讲台", example: "발표자가 강단에서 연설을 시작했다.", exampleZh: "发言人在讲台上开始演讲。", note: "场所名词", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-auditorium", pos: "名", text: "강당", zh: "礼堂", pairing: "강당에 모이다", pairingZh: "聚集在礼堂", example: "학생들과 교사들이 강당에 모였다.", exampleZh: "学生和老师们聚集在礼堂。", note: "学校场景", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-river-water", pos: "名", text: "강물", zh: "江水 / 河水", pairing: "강물을 바라보다", pairingZh: "望着河水", example: "그는 강물을 보며 아무 말도 하지 않았다.", exampleZh: "他望着河水，什么也没说。", note: "自然名词", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-instructor", pos: "名", text: "강사", zh: "讲师", pairing: "강사로 나가다", pairingZh: "担任讲师", example: "그는 여러 대학에서 강사로 일하고 있다.", exampleZh: "他正在多所大学担任讲师。", note: "职业名词", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-landscape", pos: "名", text: "강산", zh: "江山 / 山河", pairing: "강산이 변하다", pairingZh: "山河变迁", example: "십 년이면 강산도 변한다는 말이 있다.", exampleZh: "俗话说十年足以使山河变样。", note: "自然与社会", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-speaker", pos: "名", text: "강연자", zh: "演讲者", pairing: "강연자를 소개하다", pairingZh: "介绍演讲者", example: "오늘의 강연자는 대학 교수이다.", exampleZh: "今天的演讲者是一位大学教授。", note: "活动场景", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-coercion", pos: "名", text: "강요", zh: "强求 / 强迫", pairing: "희생을 강요하다", pairingZh: "强迫他人牺牲", example: "그는 동생에게 자신의 뜻을 강요했다.", exampleZh: "他把自己的意愿强加给弟弟。", note: "社会关系", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-strength", pos: "名", text: "강점", zh: "优点 / 长处", pairing: "강점이 있다", pairingZh: "具有优势", example: "이 제품의 강점은 내수성에 있다.", exampleZh: "这款产品的优势在于耐水性。", note: "评价表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-individual", pos: "名", text: "개인", zh: "个人", pairing: "개인의 취향", pairingZh: "个人喜好", example: "선택은 개인의 취향에 따라 달라진다.", exampleZh: "选择会因个人喜好而不同。", note: "人物与社会", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-overview", pos: "名", text: "개관", zh: "概观 / 概况", pairing: "전체를 개관하다", pairingZh: "概观整体", example: "이 보고서는 시장의 전체 개관을 보여 준다.", exampleZh: "这份报告展示了市场的整体概况。", note: "书面表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-firefly", pos: "名", text: "개똥벌레", zh: "萤火虫", pairing: "개똥벌레가 날다", pairingZh: "萤火虫飞舞", example: "여름밤 논밭에서 개똥벌레를 볼 수 있다.", exampleZh: "夏夜可以在田野里看到萤火虫。", note: "动物名词", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-development", pos: "名", text: "개발", zh: "开发", pairing: "개발을 추진하다", pairingZh: "推进开发", example: "지역 개발 계획이 발표되었다.", exampleZh: "地区开发计划公布了。", note: "社会经济", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-opening", pos: "名", text: "개방", zh: "开放", pairing: "문호를 개방하다", pairingZh: "对外开放", example: "휴일에는 자료실을 개방하지 않는다.", exampleZh: "资料室节假日不开放。", note: "公共信息", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-separate", pos: "名", text: "개별", zh: "个别 / 单独", pairing: "개별로 이야기하다", pairingZh: "单独交谈", example: "이 문제는 개별 상담으로 해결한다.", exampleZh: "这个问题通过个别咨询解决。", note: "范围表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-film-release", pos: "名", text: "개봉", zh: "首映 / 开封", pairing: "영화를 개봉하다", pairingZh: "电影上映", example: "새 영화가 여름에 개봉될 예정이다.", exampleZh: "新电影预计夏季上映。", note: "文化艺术", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-start", pos: "名", text: "개시", zh: "开始", pairing: "업무를 개시하다", pairingZh: "开始业务", example: "구조 작업이 곧 개시될 예정이다.", exampleZh: "救援工作即将开始。", note: "书面表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-opening-ceremony", pos: "名", text: "개업식", zh: "开业仪式", pairing: "개업식을 하다", pairingZh: "举行开业仪式", example: "새 식당이 점심에 개업식을 연다.", exampleZh: "新餐厅中午举行开业仪式。", note: "活动场景", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-solo-exhibition", pos: "名", text: "개인전", zh: "个人作品展", pairing: "개인전을 열다", pairingZh: "举办个人展", example: "화가는 첫 개인전을 준비하고 있다.", exampleZh: "画家正在准备首次个人展。", note: "文化艺术", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-individualism", pos: "名", text: "개인주의", zh: "个人主义", pairing: "개인주의가 팽배하다", pairingZh: "个人主义盛行", example: "사회에서 개인주의가 점차 강해지고 있다.", exampleZh: "社会上的个人主义逐渐增强。", note: "社会主题", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-individual-difference", pos: "名", text: "개인차", zh: "个体差异", pairing: "개인차를 인정하다", pairingZh: "承认个体差异", example: "학습 속도에는 개인차가 있다.", exampleZh: "学习速度存在个体差异。", note: "教育表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-ticket-gate", pos: "名", text: "개찰구", zh: "检票口", pairing: "개찰구를 통과하다", pairingZh: "通过检票口", example: "개찰구에서 표를 확인하고 열차를 탔다.", exampleZh: "在检票口验票后上了火车。", note: "交通场景", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-national-foundation-day", pos: "名", text: "개천절", zh: "开天节", pairing: "개천절을 기념하다", pairingZh: "纪念开天节", example: "10월 3일은 한국의 개천절이다.", exampleZh: "10月3日是韩国的开天节。", note: "韩国文化", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-hold-event", pos: "名", text: "개최", zh: "举办", pairing: "행사를 개최하다", pairingZh: "举办活动", example: "학교에서 학술 행사를 개최했다.", exampleZh: "学校举办了学术活动。", note: "活动表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-opening-traffic", pos: "名", text: "개통", zh: "开通", pairing: "도로를 개통하다", pairingZh: "开通道路", example: "새 다리의 개통 시기가 연기되었다.", exampleZh: "新桥的开通时间推迟了。", note: "交通建设", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-objective", pos: "名", text: "객관적", zh: "客观的", pairing: "객관적으로 판단하다", pairingZh: "客观判断", example: "뉴스는 사실을 객관적으로 전달해야 한다.", exampleZh: "新闻应当客观传达事实。", note: "态度表达", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" },
  { id: "mastery2-client", pos: "名", text: "거래처", zh: "客户 / 往来单位", pairing: "거래처에 연락하다", pairingZh: "联系客户", example: "해외 거래처에서 방문 요청 메일이 왔다.", exampleZh: "海外客户发来了访问请求邮件。", note: "商务场景", source: "完全掌握 TOPIK II 中高级词汇 · Unit 1" }
];
