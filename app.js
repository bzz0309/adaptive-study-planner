...
const studyTemplates = {
  listening: [
    ["听人物和地点", "短对话里先抓谁、在哪里、正在做什么"], ["听力 · 判断下一步行动", "练“接下来做什么”和请求表达"], ["听说话人意图", "判断说话目的和最想传达的信息"], ["听职业与身份", "根据职责、场所和行动判断说话人身份"], ["听说话人态度", "判断赞同、担忧、质疑或坚持等态度"], ["听主题与内容", "概括整段材料主要在说明什么"], ["听对话前文推断", "根据当前回应反推对话前文"], ["听原因和理由", "抓 못 가요、바뀌었어요 等理由线索"], ["听数字和时间", "练日期、价格、时间和数量"], ["听内容一致", "核对选项是否和原文相同"], ["听否定和时态", "听清 안、못、过去和将来"], ["看图听关键词", "先看图中差异，再听对应词"], ["听后复述", "复听、影子跟读、用中文说出大意"]
  ],
  reading: [
...
function taskDisplayTitle(task = {}, index = 0) {
  ...
  const titleMap = {
    listening: ["听人物和地点", "听力 · 判断下一步行动", "听说话人意图", "听职业与身份", "听说话人态度", "听主题与内容", "听对话前文推断", "听原因和理由", "听数字和时间", "听内容一致", "听否定和时态", "看图听关键词", "听后复述"],
