...
const studyTemplates = {
  listening: [
    ["听人物和地点", "短对话里先抓谁、在哪里、正在做什么"], ["听力 · 判断下一步行动", "练“接下来做什么”和请求表达"], ["听说话人意图", "判断说话目的和最想传达的信息"], ["听职业与身份", "根据职责、场所和行动判断说话人身份"], ["听原因和理由", "抓 못 가요、바뀌었어요 等理由线索"], ["听数字和时间", "练日期、价格、时间和数量"], ["听内容一致", "核对选项是否和原文相同"], ["听否定和时态", "听清 안、못、过去和将来"], ["看图听关键词", "先看图中差异，再听对应词"], ["听后复述", "复听、影子跟读、用中文说出大意"]
  ],
  reading: [
...
const realMaterialQuestionBank = [
  ...
  },
  {
    ...
    sourceTitle: "第102届 TOPIK II 听力真题",
    sourceDetail: "17-21、25题 · 逐题原图与原始音频",
    usage: "daily-practice",
    questions: [
      {
...
function taskDisplayTitle(task = {}, index = 0) {
  ...
  const titleMap = {
    listening: ["听人物和地点", "听力 · 判断下一步行动", "听说话人意图", "听职业与身份", "听原因和理由", "听数字和时间", "听内容一致", "听否定和时态", "看图听关键词", "听后复述"],
